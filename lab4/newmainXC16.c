...
#define LCD_CURSOR          0x80    //ob10000000
#define LINE1               0x00
#define LINE2               0x40
#define LCD_CUSTOM_CHAR     0x40    //0b10000000
...
void LCD_saveCustomChar(unsigned char slot, unsigned char *array){
    unsigned char i;
    LCD_sendCommand(LCD_CUSTOM_CHAR + slot*8);
...
int main(void) {
    ...
    LCD_setCursor(1,0);
    LCD_print("Hello wordl!");  // Wyswietlenie napisu
    LCD_sendData(0);
    __delay_ms(500);
